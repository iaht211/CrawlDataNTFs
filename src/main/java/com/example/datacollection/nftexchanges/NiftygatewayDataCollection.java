...
public class NiftygatewayDataCollection implements DataCollector<TrendingNFT> {
    ...
    public List<TrendingNFT> collectData() {
        ...
        System.setProperty("webdriver.chrome.driver", "D:\\Downloads\\javaFX-crawdata\\src\\main\\resources\\chromedriver-win64\\chromedriver.exe");
        ...
        for (Element nftElement : nftElements) {
            ...
            System.out.println(title + " " + price + " " + creator + " " + editions);
