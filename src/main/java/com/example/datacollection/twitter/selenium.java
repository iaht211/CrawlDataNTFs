...
//    private static final String SCROLL_SCRIPT = "window.scrollTo(0, document.body.scrollHeight);";
    ...
    public static void main(String[] args) {
        ...
        String keyword = "art";
        run(keyword, "2023-12-22", "2023-12-23");
        printToScreen();
    }
    ...
    public static List<Tweet> getTweets(String keyword, String startDay, String endDay) {
        ...
        while (startDay.compareTo(endDay) <= 0) {
            search(driver, keyword, startDay,endDay, MIN_FAVES, MIN_RETWEET, MIN_REPLY, FILTER_REPLIES);
            ...
            try {
                ...
                // Bạn có thể giữ driver mở ở đây nếu bạn muốn sử dụng driver sau này
                // driver.quit();
            }
        ...
        // Cuối cùng, đảm bảo đóng driver khi đã sử dụng xong
        driver.quit();
    ...
    private static void search(WebDriver driver, String keyword, String since,String until, int min_faves, int min_retweets, int min_replies, int filter_replies) {
        String search_url = "https://twitter.com/search?q=" + queryMaker(keyword, since, until, min_faves, min_retweets, min_replies, filter_replies) + "&src=typed_query&f=live";
    ...
    private static String queryMaker(String keyword, String since, String until, int min_faves, int min_retweets, int min_replies, int filter_replies) {
        //until = since + 3 days
...
//        String extensionPath = "D:\\New folder (2)\\tweet-crawl-proj\\src\\Adguard.crx";
